...
def validate_lenght_pw():
  ...
  generated_password = ""
  if(val_check_button1.get() or val_check_button2.get() or val_check_button3.get() or val_check_button4.get()):
    try:
  ...
  for i in range(lenght_of_password):
    ...
    if(val_check_button1.get() == 0 and val_check_button2.get() == 0 and val_check_button3.get() and val_check_button4.get()):
      ...
      if(x == 2):
        ...
        y = random.randint(0,25)
      tmp_pw.append(get_random_char(x,y))
    if(val_check_button1.get() == 0 and val_check_button2.get() == 0 and val_check_button3.get() == 0 and val_check_button4.get()):
      x = 3
      y = 0
      if(x == 3):
        y = random.randint(0,25)
      tmp_pw.append(get_random_char(x,y))
    if(val_check_button1.get() == 0 and val_check_button2.get() and val_check_button3.get() == 0 and val_check_button4.get() == 0):
      x = 1
      y = 0
      if(x == 1):
        y = random.randint(0,9)
      tmp_pw.append(get_random_char(x,y))
    if(val_check_button1.get() and val_check_button2.get() == 0 and val_check_button3.get() == 0 and val_check_button4.get() == 0):
      x = 0
      y = 0
      if(x == 0):
        y = random.randint(0,24)
